...
Vagrant.configure('2') do |config|
  ...
  config.vm.define :puppetmaster1 do |puppetmaster1_config|
    puppetmaster1_config.vm.network :private_network, ip: "192.168.21.131"
  ...
  config.vm.define :ci1 do |ci1_config|
    ci1_config.vm.network :private_network, ip: "192.168.21.132"
  ...
  config.vm.define :node1 do |node1_config|
    node1_config.vm.network :private_network, ip: "192.168.21.140"
  ...
  config.vm.define :node2 do |node2_config|
    ...
    node2_config.vm.network :private_network, ip: "192.168.21.141"
  ...
  config.vm.define :node3 do |node3_config|
    ...
    node3_config.vm.network :private_network, ip: "192.168.21.142"
  ...
  config.vm.define :node4 do |node4_config|
    ...
    node4_config.vm.network :private_network, ip: "192.168.21.143"
